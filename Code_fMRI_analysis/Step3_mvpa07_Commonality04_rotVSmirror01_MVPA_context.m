...
cd ..
mkdir('MVPA_TaskContext_rotationVSmirror'); cd('MVPA_TaskContext_rotationVSmirror');
pathMVPA = pwd;
...
%     labelnames = {'erasing_Rot90_upward','erasing_Rot90_downward','erasing_Rot270_upward','erasing_Rot270_downward'};
    ...
    cfg.design.label = repmat(cfg.design.label(:,1),[1,size(temp_mat_train,2)]);
    cfg.design.set = repmat(cfg.design.set(:,1),[1,size(temp_mat_train,2)]);
